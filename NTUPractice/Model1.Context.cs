...
namespace NTUPractice
{
    ...
    public partial class AdventureWorks2017Entities1 : DbContext
    {
        ...
        [DbFunction("AdventureWorks2017Entities1", "ufnGetContactInformation")]
        public virtual IQueryable<ufnGetContactInformation_Result> ufnGetContactInformation(Nullable<int> personID)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<ufnGetContactInformation_Result>("[AdventureWorks2017Entities1].[ufnGetContactInformation](@PersonID)", personIDParameter);
        }
